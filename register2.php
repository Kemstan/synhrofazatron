...
<input type="text" autocomplete="off" class="enter" name="word3" autocomplete="off" id="clickme3" onkeydown="processKeyDown3(event)" onkeyup="processKeyUp3(event)" value="" size="18" maxlength="14"></input>
<input name="push_key3" class="hide" id="push_key3" type="hidden" size="18"></input>
<input name="delta_key3" class="hide" id="delta_key3"  type="hidden" size="18"/></input>
